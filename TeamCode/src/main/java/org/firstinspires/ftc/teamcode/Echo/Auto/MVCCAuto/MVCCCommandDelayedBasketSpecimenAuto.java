...
public class MVCCCommandDelayedBasketSpecimenAuto extends OpMode {
...
//        RedBasket_LeftSampleToBasket = new ActionCommand (redBasket_LeftSampleToBasket, requirements);
        ...
        CommandScheduler.getInstance().schedule(
                ...
                new SequentialCommandGroup(
                        ...
                        new ParallelActionCommand5Specimen(arm, wrist, gripper, lift, extendo, intake, exampleSubsystem, "redBasket_StartToSub"),
