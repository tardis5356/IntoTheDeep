...
@Config
public class MecanumDriveSpecimen {
    public static class Params {
        ...
        public double trackWidthTicks =8055.923797863967; //24180.892621514482
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer() {
            leftFront = new OverflowEncoder(new RawEncoder(MecanumDriveSpecimen.this.leftFront));
            leftBack = new OverflowEncoder(new RawEncoder(MecanumDriveSpecimen.this.leftBack));
            rightBack = new OverflowEncoder(new RawEncoder(MecanumDriveSpecimen.this.rightBack));
            rightFront = new OverflowEncoder(new RawEncoder(MecanumDriveSpecimen.this.rightFront));
    ...
    public MecanumDriveSpecimen(HardwareMap hardwareMap, Pose2d pose) {
        this.pose = pose;
