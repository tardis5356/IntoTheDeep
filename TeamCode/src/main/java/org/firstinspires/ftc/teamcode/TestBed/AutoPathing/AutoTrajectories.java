...
public class AutoTrajectories {
    ...
    //Red Specimen Poses
   public static final Pose2d redSpec_StartPos = new Pose2d(16, -66, Math.toRadians(90));
 //   public static final Pose2d redSpec_StartPos = new Pose2d(40, -64, Math.toRadians(90));
    ...
    public static final Pose2d redSpec_LeftSpecDepoPos = new Pose2d(50, -52, Math.toRadians(90));
    public static final Pose2d redSpec_MidSpecZonePos = new Pose2d(60, -14, Math.toRadians(90));
    public static final Pose2d redSpec_MidSpecDepoPos = new Pose2d(60, -52, Math.toRadians(90));
    public static final Pose2d redSpec_RightSpecZonePos = new Pose2d(66, -14, Math.toRadians(90));
    public static final Pose2d redSpec_RightSpecDepoPos = new Pose2d(66, -61, Math.toRadians(90));
...
//Actions
   ...
   //Red
    ...
    public static Action redSpec_LeftSpecToMidWay;
    ...
    public static void generateTrajectories(MecanumDrive drive) {
        ...
        redSpec_RightSpecToObs =
                drive.actionBuilder(redSpec_RightSpecZonePos)
                        .setTangent(180)
                        .splineToLinearHeading(redSpec_RightSpecDepoPos, Math.toRadians(330))
        ...
        redSpec_ObsToSub =
                drive.actionBuilder(redSpec_ObsSpecCheckPos)
                        .setTangent(150)
