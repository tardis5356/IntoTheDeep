...
import org.firstinspires.ftc.teamcode.Echo.Subsystems.Custom_PID_Lift;
...
public class KISS_Hang_Debug extends CommandOpMode {
    //gamepads
...
//    ButtonReader reader = new ButtonReader(driver1, GamepadKeys.Button.RIGHT_BUMPER);
    ...
    public void initialize() {
        ...
        //lift
        lift = new Custom_PID_Lift(hardwareMap);
        ...
        new Trigger(() -> driver1.getButton(GamepadKeys.Button.DPAD_RIGHT))
            ...
            new Trigger(() -> driver1.getButton(GamepadKeys.Button.DPAD_UP))
                    .whenActive(new SequentialCommandGroup(
                                    new InstantCommand(() -> AllianceColor.cycleType = "basket"),
                                    new InstantCommand(() -> savedCycleType = "basket")
                            )
                    );
            ...
            new Trigger(() -> driver1.getButton(GamepadKeys.Button.DPAD_DOWN))
                    .whenActive(
                            new SequentialCommandGroup(
                                    ...
                                    new InstantCommand(() -> savedCycleType = "specimen")
                            )
                    );
        }
...
//                    .whenActive(new InstantCommand(intake::checkBlue));
        ...
        //intake inning and outing
            ...
            new Trigger(() -> (driver1.getButton(GamepadKeys.Button.RIGHT_BUMPER)) && (!driver2.getButton(GamepadKeys.Button.LEFT_BUMPER) || !driver1.getButton(GamepadKeys.Button.Y)))
                    .whenActive(
                            new SequentialCommandGroup(
...
//        }
        ...
        telemetry.addData("Lift_Power", lift.mLB.getPower());
