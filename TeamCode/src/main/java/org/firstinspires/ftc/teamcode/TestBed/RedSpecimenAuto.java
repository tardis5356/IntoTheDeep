...
public class RedSpecimenAuto extends LinearOpMode {
    ...
    public final Pose2d redSpec_RightSampleZonePos = new Pose2d(62, -10, Math.toRadians(75));
    public final Pose2d redSpec_MidSampleZonePos = new Pose2d(58, -48, Math.toRadians(90));
    public final Pose2d redSpec_LeftSampleZonePos = new Pose2d(50, -48, Math.toRadians(450));
    ...
    public void runOpMode() {
        ...
        Action RedSpecAuto = drive.actionBuilder(initialPose)
                .setTangent(0)
                .splineToSplineHeading(redSpec_LeftSampleZonePos, Math.toRadians(90))
...
//                .setTangent(90)
//                .splineToLinearHeading(redSpec_SubDepoPos, Math.toRadians(90))
//                .waitSeconds(1) //Pick up Specimen from Obs Zone
//                .setTangent()
                .build();
