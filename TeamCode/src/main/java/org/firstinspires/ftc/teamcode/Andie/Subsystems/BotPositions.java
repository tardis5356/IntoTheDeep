...
public class BotPositions {
    ...
    public static double WRIST_TRANSIT = 0.87, WRIST_WALL = .8, WRIST_INTAKE = .67, WRIST_BASKET = .46, WRIST_SPECIMEN = .5;
    public static double ARM_BASKET = .92, ARM_INTAKE = .35, ARM_WALL = .18, ARM_TRANSIT = .5, ARM_SPECIMEN =.57;
    public static double INTAKE_UP = 0.17, INTAKE_DOWN = 0.33, INTAKE_IN = 1, INTAKE_OUT = -1, INTAKE_STOP = 0;
