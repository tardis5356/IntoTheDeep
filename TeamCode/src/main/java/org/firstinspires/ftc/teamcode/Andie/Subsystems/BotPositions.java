...
public class BotPositions {
    ...
    public static double INTAKE_NEUTRAL = 0, INTAKE_DOWN = 0.3, INTAKE_IN = 1, INTAKE_OUT = -1, INTAKE_STOP = 0;
    public static double EXTENDO_IN = 1, EXTENDO_OUT = 0, EXTENDO_MIDDLE;
