...
public class BotPositions {
    ...
    public static double WRIST_TRANSIT = 0.87, WRIST_WALL = .75, WRIST_INTAKE = .66, WRIST_BASKET = .5, WRIST_SPECIMEN = .58;
    public static double ARM_BASKET = .85, ARM_INTAKE = .29, ARM_WALL = .08, ARM_TRANSIT = .5, ARM_SPECIMEN =.57;
    public static double INTAKE_UP = 0.069, INTAKE_DOWN = 0.35, INTAKE_IN = 1, INTAKE_OUT = -1, INTAKE_STOP = 0;
    public static double EXTENDO_IN = 0.785, EXTENDO_OUT = .4, EXTENDO_SPECLEFT =.65, EXTENDO_SPECMID =.53, EXTENDO_SPECRIGHT = .4;
    public static int LIFT_WALL = -235, LIFT_SPECIMEN_HIGH = -720, LIFT_SPECIMEN_LOW = 0, LIFT_BASKET_HIGH = -2990, LIFT_BASKET_LOW = -280, LIFT_TRANSIT = -700, LIFT_LIMIT = -3000, LIFT_TOLERANCE = 10;
