...
public class BotPositions {
    ...
    public static double INTAKE_UP = 0.079, INTAKE_DOWN = 0.215, INTAKE_IN = 1, INTAKE_OUT = -1, INTAKE_STOP = 0;
    public static double EXTENDO_IN = 0.8, EXTENDO_OUT = .7, EXTENDO_MIDDLE =.7;
    public static int LIFT_WALL = 10, LIFT_SPECIMEN_HIGH = 10, LIFT_SPECIMEN_LOW = 10, LIFT_BASKET_HIGH = 10, LIFT_BASKET_LOW = 10, LIFT_TRANSIT = 10;
