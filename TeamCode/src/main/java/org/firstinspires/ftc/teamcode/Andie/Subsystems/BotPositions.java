...
public class BotPositions {
    ...
    public static int LIFT_WALL = -235, LIFT_SPECIMEN_HIGH = -720, LIFT_SPECIMEN_LOW = 0, LIFT_BASKET_HIGH = -2990, LIFT_BASKET_LOW = -280, LIFT_TRANSIT = -800, LIFT_LIMIT = -3000, LIFT_TOLERANCE = 10;
