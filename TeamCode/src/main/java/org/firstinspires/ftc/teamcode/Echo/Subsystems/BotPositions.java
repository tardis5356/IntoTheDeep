...
public class BotPositions {
    ...
    public static double ARM_BASKET = .85, ARM_INTAKE = .38, ARM_WALL = .2, ARM_TRANSIT = .5, ARM_SPECIMEN =.67, ARM_SPECIMEN_HANG =.78, ARM_HANG = .61, ARM_START = .7;
    ...
    public static int LIFT_WALL = -120, LIFT_SPECIMEN_HIGH = -600, LIFT_SPECIMEN_LOW = 0, LIFT_BASKET_HIGH = -3000,
