...
public class BotPositions {
    ...
    public static int LIFT_WALL = -300, LIFT_SPECIMEN_HIGH = -1850, LIFT_SPECIMEN_LOW = 0, LIFT_BASKET_HIGH = -3050,
            LIFT_BASKET_LOW = -890, LIFT_TRANSIT = -980, LIFT_LIMIT = -3100, LIFT_TOLERANCE = 10, LIFT_INTAKE = -530, LIFT_SPECIMEN_HIGH_CLIP = -2850;
