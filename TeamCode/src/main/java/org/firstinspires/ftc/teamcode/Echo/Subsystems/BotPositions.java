...
public class BotPositions {
    ...
    public static double WRIST_TRANSIT = 0.87, WRIST_WALL = .78, WRIST_INTAKE = .3, WRIST_BASKET = .4, WRIST_SPECIMEN = .28;
    public static double ARM_BASKET = .85, ARM_INTAKE = .37, ARM_WALL = .2, ARM_TRANSIT = .5, ARM_SPECIMEN =.43, ARM_HANG = .61, ARM_START = .7;
    public static double INTAKE_ARM_DOWN = 0.97, INTAKE_ARM_TRANSFER = 0.38, INTAKE_ARM_UP = .77, INTAKE_ARM_OUTAKE = .16,
    ...
    public static int LIFT_WALL = -300, LIFT_SPECIMEN_HIGH = -1850, LIFT_SPECIMEN_LOW = 0, LIFT_BASKET_HIGH = -3000,
            LIFT_BASKET_LOW = -890, LIFT_TRANSIT = -980, LIFT_LIMIT = -3050, LIFT_TOLERANCE = 10, LIFT_INTAKE = -520, LIFT_SPECIMEN_HIGH_CLIP = -2850;
    ...
    public static double LIFT_P = 0.007, LIFT_D = 0.00025, LIFT_I = 0.000;
}
