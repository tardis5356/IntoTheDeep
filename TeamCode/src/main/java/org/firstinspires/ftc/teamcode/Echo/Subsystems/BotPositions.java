...
public class BotPositions {
    ...
    public static double INTAKE_ARM_DOWN = 0.93, INTAKE_ARM_TRANSFER = 0.38, INTAKE_ARM_UP = .77, INTAKE_ARM_OUTAKE = .16,
    ...
    public static int LIFT_WALL = -300, LIFT_SPECIMEN_HIGH = -1850, LIFT_SPECIMEN_LOW = 0, LIFT_BASKET_HIGH = -3000,
            LIFT_BASKET_LOW = -890, LIFT_TRANSIT = -980, LIFT_LIMIT = -3050, LIFT_TOLERANCE = 80, LIFT_INTAKE = -470, LIFT_SPECIMEN_HIGH_CLIP = -2850; //LIFT_TOLERANCE = 10 //100 is 1 inch
