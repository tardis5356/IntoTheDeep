...
public class BotPositions {
    public static double GRIPPER_OPEN = .6, GRIPPER_CLOSED = 0.35, GRIPPER_INTAKE = .475;
    ...
    public static int LIFT_WALL = -300, LIFT_SPECIMEN_HIGH = -2000, LIFT_SPECIMEN_LOW = 0, LIFT_BASKET_HIGH = -3050,
            LIFT_BASKET_LOW = -890, LIFT_TRANSIT = -980, LIFT_LIMIT = -3100, LIFT_TOLERANCE = 10, LIFT_INTAKE = -530;
