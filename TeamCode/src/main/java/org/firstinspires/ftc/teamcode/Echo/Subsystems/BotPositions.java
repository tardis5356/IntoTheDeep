...
public class BotPositions {
    ...
    public static double VINTAKE_TRANSFER = 0.5, VINTAKE_UP = .65, VINTAKE_DOWN = .71, VINTAKE_SWEEP=.83;

    public static int LIFT_WALL_AUTO = -1800, LIFT_SPECIMEN_HIGH_AUTO = -10000,LIFT_BASKET_HIGH_AUTO = -49000, //SPECIMEN_HIGH_AUTO=-9000
            LIFT_BASKET_LOW_AUTO = -13350, LIFT_TRANSIT_AUTO = -14700, LIFT_INTAKE_AUTO = -6800, LIFT_SPECIMEN_HIGH_CLIP_AUTO = -47250, LIFT_TOLERANCE_AUTO = 1500,LIFT_TOLERANCE_TIGHT_AUTO = 800;//1700 is 1 inch
