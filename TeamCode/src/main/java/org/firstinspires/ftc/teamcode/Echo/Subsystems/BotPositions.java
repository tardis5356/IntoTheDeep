...
public class BotPositions {
    ...
    public static int LIFT_WALL = -120, LIFT_SPECIMEN_HIGH = -600, LIFT_SPECIMEN_LOW = 0, LIFT_BASKET_HIGH = -3200,
            LIFT_BASKET_LOW = -890, LIFT_TRANSIT = -980, LIFT_LIMIT = -3300, LIFT_INTAKE = -435, LIFT_SPECIMEN_HIGH_CLIP = -3100, LIFT_TOLERANCE = 80,LIFT_TOLERANCE_MED = 35, LIFT_TOLERANCE_TIGHT = 10;//100 is 1 inch
