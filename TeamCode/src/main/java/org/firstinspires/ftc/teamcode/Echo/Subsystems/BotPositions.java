...
public class BotPositions {
    ...
    public static double WRIST_TRANSIT = 0.87, WRIST_WALL = .78, WRIST_INTAKE = .33, WRIST_BASKET = .15, WRIST_SPECIMEN = .5;
    public static double ARM_BASKET = .85, ARM_INTAKE = .44, ARM_WALL = .2, ARM_TRANSIT = .5, ARM_SPECIMEN =.67, ARM_SPECIMEN_HANG =.78, ARM_HANG = .61, ARM_START = .7;
    ...
    public static int LIFT_WALL = -1800, LIFT_SPECIMEN_HIGH = -9000, LIFT_SPECIMEN_LOW = 0, LIFT_BASKET_HIGH = -49000,
            LIFT_BASKET_LOW = -13350, LIFT_TRANSIT = -14700, LIFT_LIMIT = -50250, LIFT_INTAKE = -6600, LIFT_SPECIMEN_HIGH_CLIP = -47250, LIFT_TOLERANCE = 1500,LIFT_TOLERANCE_MED = 35, LIFT_TOLERANCE_TIGHT = 10;//100 is 1 inch
