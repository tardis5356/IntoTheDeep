...
public class BotPositions {
    ...
    public static double ARM_BASKET = .87, ARM_INTAKE = .49, ARM_WALL = .2, ARM_TRANSIT = .5, ARM_SPECIMEN =.7, ARM_SPECIMEN_HANG =.8, ARM_HANG = .61, ARM_START = .7, ARM_SPECIMEN_AUTO =0.67, ARM_SPECIMEN_HANG_AUTO =0.8;
    ...
    public static int LIFT_WALL_AUTO = -1800, LIFT_SPECIMEN_HIGH_AUTO = -14500,LIFT_BASKET_HIGH_AUTO = -49000, //SPECIMEN_HIGH_AUTO=-9000
            LIFT_BASKET_LOW_AUTO = -13350, LIFT_TRANSIT_AUTO = -14700, LIFT_INTAKE_AUTO = -2000, LIFT_SPECIMEN_HIGH_CLIP_AUTO = -47250, LIFT_TOLERANCE_AUTO = 500,LIFT_TOLERANCE_TIGHT_AUTO = 500;//1700 is 1 inch
