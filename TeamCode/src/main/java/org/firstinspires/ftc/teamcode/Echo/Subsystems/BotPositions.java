...
public class BotPositions {
    ...
    public static double WRIST_TRANSIT = 0.87, WRIST_WALL = .78, WRIST_INTAKE = .31, WRIST_BASKET = .15, WRIST_SPECIMEN = .5;
    ...
    public static int LIFT_WALL = -1800, LIFT_SPECIMEN_HIGH = -9000, LIFT_SPECIMEN_LOW = 0, LIFT_BASKET_HIGH = -49000,
            LIFT_BASKET_LOW = -13350, LIFT_TRANSIT = -14700, LIFT_LIMIT = -49500, LIFT_INTAKE = -7000, LIFT_SPECIMEN_HIGH_CLIP = -47250, LIFT_TOLERANCE = 1200,LIFT_TOLERANCE_MED = 35, LIFT_TOLERANCE_TIGHT = 10;//100 is 1 inch
    ...
    public static double LIFT_P = 0.0003, LIFT_D = 0.0000, LIFT_I = 0.000;
