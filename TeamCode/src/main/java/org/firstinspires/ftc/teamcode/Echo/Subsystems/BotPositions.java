...
public class BotPositions {
    ...
    public static double INTAKE_ARM_DOWN = .89, INTAKE_ARM_DOWN_AUTO = 0.97,INTAKE_ARM_TRANSFER = 0.38, INTAKE_ARM_UP = .77, INTAKE_ARM_OUTAKE = .16,
            INTAKE_WRIST_DOWN = .80, INTAKE_WRIST_DOWN_AUTO = .95, INTAKE_WRIST_TRANSFER = .05, INTAKE_WRIST_UP = .8, INTAKE_WRIST_OUTAKE = .2,
    ...
    public static int LIFT_WALL = -230, LIFT_SPECIMEN_HIGH = -1950, LIFT_SPECIMEN_LOW = 0, LIFT_BASKET_HIGH = -3000,
            LIFT_BASKET_LOW = -890, LIFT_TRANSIT = -980, LIFT_LIMIT = -3050, LIFT_INTAKE = -500, LIFT_SPECIMEN_HIGH_CLIP = -3100, LIFT_TOLERANCE = 80,LIFT_TOLERANCE_MED = 35, LIFT_TOLERANCE_TIGHT = 10;//100 is 1 inch
