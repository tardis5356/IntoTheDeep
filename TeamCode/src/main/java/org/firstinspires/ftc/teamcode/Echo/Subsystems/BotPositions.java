...
public class BotPositions {
    ...
    public static int LIFT_WALL = -1000, LIFT_SPECIMEN_HIGH = -9000, LIFT_SPECIMEN_LOW = 0, LIFT_BASKET_HIGH = -49000,
            LIFT_BASKET_LOW = -13350, LIFT_TRANSIT = -14700, LIFT_LIMIT = -52500, LIFT_INTAKE = -5800, LIFT_SPECIMEN_HIGH_CLIP = -47250, LIFT_TOLERANCE = 1500,LIFT_TOLERANCE_MED = 35, LIFT_TOLERANCE_TIGHT = 800;//100 is 1 inch
