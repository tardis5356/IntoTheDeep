...
public class BotPositions {
    ...
    public static double EXTENDO_IN = 0.82, EXTENDO_OUT = .51, EXTENDO_SPECLEFT =.66, EXTENDO_SPECMID =.54, EXTENDO_SPECRIGHT = .51;
    ...
    public static int LIFT_WALL = -1800, LIFT_SPECIMEN_HIGH = -10000, LIFT_SPECIMEN_LOW = 0, LIFT_BASKET_HIGH = -49000,
            LIFT_BASKET_LOW = -13350, LIFT_TRANSIT = -14700, LIFT_LIMIT = -52500, LIFT_INTAKE = -6000, LIFT_SPECIMEN_HIGH_CLIP = -47250, LIFT_TOLERANCE = 1000,LIFT_TOLERANCE_MED = 35, LIFT_TOLERANCE_TIGHT = 800;
