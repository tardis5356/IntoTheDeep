...
public class BotPositions {
    ...
    public static double ARM_BASKET = .87, ARM_INTAKE = .49, ARM_WALL = .2, ARM_TRANSIT = .5, ARM_SPECIMEN =.7, ARM_SPECIMEN_HANG =.8, ARM_HANG = .61, ARM_START = .7;
    ...
    public static int LIFT_WALL = -1800, LIFT_SPECIMEN_HIGH = -10000, LIFT_SPECIMEN_LOW = 0, LIFT_BASKET_HIGH = -49000,
            LIFT_BASKET_LOW = -13350, LIFT_TRANSIT = -14700, LIFT_LIMIT = -52500, LIFT_INTAKE = -2400
    ...
    public static double VINTAKE_TRANSFER = 0.5, VINTAKE_UP = .65, VINTAKE_DOWN = .71, VINTAKE_SWEEP=.8;
